...
(function () {
  ...
  var INDEX = [
    /* Top-level pages */
    { title: 'Home',                       url: '/',                  cat: 'Page',     kw: 'home landing main mo-ark district missouri arkansas' },
    { title: 'About MO-ARK',               url: 'about',                  cat: 'Page',     kw: 'about story who we are' },
    { title: 'Our History',                url: 'about#history',          cat: 'Section',  kw: 'history 1957 founding past origin' },
    { title: 'Mission & Values',           url: 'about#mission',          cat: 'Section',  kw: 'mission values pillars principles purpose' },
    { title: 'Our District',               url: 'our-district',           cat: 'Page',     kw: 'district overview missouri arkansas divisions' },
    { title: 'District Board',             url: 'our-district#board',     cat: 'Section',  kw: 'board governor lieutenant governors leadership executives officers exec' },
    { title: 'Club Directory',             url: 'our-district#clubs',     cat: 'Section',  kw: 'clubs schools directory map find my club search lookup' },
    { title: 'District Bylaws',            url: 'our-district#bylaws',    cat: 'Section',  kw: 'bylaws rules governance constitution policies pdf' },
    { title: 'Resources',                  url: 'resources',              cat: 'Page',     kw: 'resources forms guides downloads tools' },
    { title: 'Club Resources',             url: 'resources#club',         cat: 'Section',  kw: 'club resources officer guidebook materials' },
    { title: 'Club Officer Guidebooks',     url: 'https://30f956d5-a7e6-4aee-97dd-e9b69fd1592b.filesusr.com/ugd/ffc875_f4de42f229314b87948a54ed4aeebb68.pdf', cat: 'File', kw: 'club officer guidebooks officers pdf president secretary treasurer webmaster editor governor', external: true },
    { title: 'Circle K Brand Guide',        url: 'http://www.georgiacirclek.org/uploads/1/2/5/4/12543983/cki_brand_book__2016_-compressed.pdf', cat: 'File', kw: 'circle k brand guide style guide graphics logos seal wordmark pdf', external: true },
    { title: 'Membership Dues',             url: 'https://www.circlek.org/membership/dues/', cat: 'File', kw: 'membership dues pay club dues annual dues circle k', external: true },
    { title: 'DCON Forms',                 url: 'resources#forms',        cat: 'Section',  kw: 'forms registration candidate packet dcon' },
    { title: 'Charities & Programs',       url: 'programs-charities',            cat: 'Page',    kw: 'charities programs service' },
    ...
    { title: 'Russel Haynes',               url: 'exec-profile?id=governor', cat: 'Page',   kw: 'governor district officer executive board russel haynes' },
    { title: 'Hailey Bagby',                url: 'exec-profile?id=secretary', cat: 'Page',  kw: 'secretary treasurer secretary-treasurer district officer executive board hailey bagby' },
    { title: 'Taylor Von Wolfseck',         url: 'exec-profile?id=editor', cat: 'Page',     kw: 'editor district officer executive board taylor von wolfseck' },
    { title: 'Lindenwood University CKI',    url: 'our-district#clubs',       cat: 'Section',  kw: 'lindenwood university circle k club st charles missouri LU' },
    { title: 'Missouri State University CKI', url: 'our-district#clubs',      cat: 'Section',  kw: 'missouri state university circle k club springfield MSU' },
    { title: 'University of Central Arkansas CKI', url: 'our-district#clubs', cat: 'Section',  kw: 'university of central arkansas circle k club conway UCA' },
    { title: 'University of Missouri CKI',   url: 'our-district#clubs',       cat: 'Section',  kw: 'university of missouri mizzou circle k club columbia MU' },
    { title: 'Washington University CKI',    url: 'our-district#clubs',       cat: 'Section',  kw: 'washington university washu circle k club st louis WU' },
    { title: 'Three Rivers College CKI',     url: 'our-district#clubs',       cat: 'Section',  kw: 'three rivers college circle k club poplar bluff TRC' },
    ...
    { title: 'X-Hunger',                   url: 'programs-charities#charities', cat: 'Charity', kw: 'x-hunger hunger food insecurity', external: false },
    { title: 'Active Minds',              url: 'https://www.activeminds.org', cat: 'Charity',  kw: 'active minds mental health awareness college students', external: true },
    { title: 'The Nature Conservancy',     url: 'https://www.nature.org',      cat: 'Charity',  kw: 'nature conservancy environment conservation sustainability', external: true },

    /* Common quick answers */
    { title: 'Mollie the Mule (Ask)',    url: '#open-mollie',                 cat: 'Help',     kw: 'mollie mule chat ai assistant ask questions help support' },
  ...
  function render(q){
    ...
    if (!q || !q.trim()){
      ...
      var SUGGESTED = ['Home','DCON 2027','Event Calendar','Club Directory','Resources','Charities & Programs','Contact Us'];
    ...
    if (!scored.length){
      results.innerHTML = '<div class="ss-empty"><div class="ss-empty-icon">🔍</div>No results for "' + escapeHtml(q) + '". Try DCON, calendar, board, or a charity name.</div>';
      return;
    }
    var html = '';
