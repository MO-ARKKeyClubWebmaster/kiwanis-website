...
(function () {
  ...
  var INDEX = [
    ...
    { title: 'Our History',                url: 'about.html#history',          cat: 'Section',  kw: 'history 1957 founding past origin' },
    ...
    { title: 'DCON Forms',                 url: 'resources.html#forms',        cat: 'Section',  kw: 'forms registration candidate packet dcon' },
    { title: 'Charities & Programs',       url: 'programs-charities.html',            cat: 'Page',    kw: 'charities programs service' },
    { title: 'Preferred Charities',        url: 'programs-charities.html#charities',  cat: 'Section', kw: 'preferred charities unicef x-hunger active minds nature conservancy' },
    { title: 'Programs & Foundations',     url: 'programs-charities.html#programs',   cat: 'Section', kw: 'programs yof youth opportunities fund glc global leadership certificate tomorrow fund earl collins foundation' },
    { title: 'DCON 2027',                  url: 'dcon.html',                   cat: 'Event',    kw: 'dcon district convention 2027 march circle k' },
    { title: 'Event Calendar',             url: 'dcon.html#calendar',          cat: 'Event',    kw: 'event calendar dates board meetings conferences dcon' },
    ...
    { title: 'X-Hunger',                   url: 'programs-charities.html#charities', cat: 'Charity', kw: 'x-hunger hunger food insecurity', external: false },
